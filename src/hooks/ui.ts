...
export const windowScrollObserver = (height: number, pixelOffset = 0) =>
...
export const elementScrollObserver = (element: HTMLElement) =>
...
export const useScrollPage = (offset = 0): ScrollPageData => {
  ...
  React.useLayoutEffect(() => {
    ...
    const subscription = windowScrollObserver(height, offset).subscribe(
      setPageData
    );
    return () => {
