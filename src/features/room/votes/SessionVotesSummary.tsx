...
import { AvatarContext } from "@/features/avatar/AvatarProvider";
import UserVote from "@/features/room/votes/UserVote";
...
const SessionVotesSummary = ({ users, userId }: SessionVotesSummaryProps) => {
	...
	const [[currentUser], participants] = partition(
		users ?? [],
		(user) => user.id === userId,
	);
	const [firstHalf, secondHalf] = chunk(
		participants,
